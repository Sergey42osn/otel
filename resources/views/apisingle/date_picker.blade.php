...
<div class="availabilty-block">
    <div class="d-flex justify-content-between flex-column flex-lg-row">
        <div id="calendar-input-box" class="calendar-input-box">
            ...
            <input type="hidden"  name="check_in" value="{{ $info['check_in'] }}"  id="check_in">
            <input type="hidden"  name="check_out" value="{{ $info['check_out'] }}"  id="check_out">
            <div>
        ...
        <input type="hidden" value="" name="hotelId" data-id="" class="hotelId">
        <input type="hidden" value="{{$info_hotel_search['info']->id}}" name="id" data-id="{{$info_hotel_search['info']->id}}" class="accId">
        <input type="hidden" value="{{ app()->getLocale() }}" name="language" id="language" class="hotelId">
        ...
        <div class="people-input-box">
            ...
            <input type="hidden" data-id="{{$id}}" class="hiddenAdultCount" name="adults" value="{{$adultCount}}">
            <input type="hidden" data-id="{{$id}}" class="hiddenChildCount" name="children" value="{{$childCount}}">
        ...
        <div>
            <button class="btn-blue checkAvailabilityApiIsland" data-id="{{$id}}" >@lang('accommodation.checkAvailability')</button>
        </div>
    </div>
</div>
