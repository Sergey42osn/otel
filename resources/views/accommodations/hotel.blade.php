                    ...
                    <div class="col-12 col-lg-9">
                        <div class="hotel-description flex-column flex-md-row ">
                            ...
                            <div class="d-flex flex-row-reverse justify-content-md-end flex-md-row justify-content-between align-items-center">
                                ...
                                <input type="hidden" value="{{$accommodation->wishList && Auth::check() && Auth::user()->id==$accommodation->wishList->user_id && $accommodation->wishList?$accommodation->wishList->id : null}}" class="wish-list">
                        ...
                        <div class="hotel-location">
                            @if($accommodation->address)
                                <p>{{$country . ' ' . $city . ' ' .$accommodation->address->zip_code.' '.$accommodation->address->street_house}}</p>
                            @endif
                        </div>
                        @include('accommodations.slider', [compact('accommodation'), 'type' => 'hotel'])
                    </div>
                    ...
                    <div id="rooms-list">
                        ...
                        @if($not_empty)
                            ...
                            @if(isset($available_room_info[$room->code_from_api][$room->api_plane_id]))
                                    @include('accommodations.room', compact('room', 'accommodation', 'rate_plans','room_id'))
                                @endif
                            @endforeach
                        @else
