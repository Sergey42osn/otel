...
<script>
    $(document).ready(function() {
        jQuery.extend(jQuery.validator.messages, {
            ...
            validHour: "{{ __('validation.jq_validate_msgs.validHour') }}",
            validHourto: "{{ __('validation.jq_validate_msgs.validHourto') }}",
            validNumber: "{{ __('validation.jq_validate_msgs.validNumber') }}"
        });
