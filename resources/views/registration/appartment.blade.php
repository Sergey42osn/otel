...
@section('contents')
    ...
    <div id="hotel-page">
        <div class="container">
            ...
            <form action="{{ route('appartments.store', ['locale' => App::getLocale()])}}" class="hotel-form general-form" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="hidden" name="accommodation_type" value="apartment">
                                ...
                                <section class="name-block info-block">
                                    <div>
                                        <div class="d-flex justify-content-between align-items-end label-part">
                                            <label for="" class="d-block">{{ __('hotel.appartment_name')}}*</label>
                                ...
                                <div class="country">
                                    ...
                                    <select name="country" id="country" class="form-control inputId">
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{$country->id}}" data-iso="{{$country->iso2}}">{{$country->name}}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="input-block">
                        ...
                        <fieldset class="more-beds d-flex radio-btn-block">
                            <div class="d-flex align-items-center">
                                <input type="radio" name="extra_beds" id="yes" value="1" checked>
                ...
                <section class="services-block info-block">
                    ...
                    <section class="room-info-block block">
                        <div class="input-block">
                            <p>{{ __('rooms.about_propterty')}}</p>
                            <fieldset>
                                <div class="part-block">
                                    <label for="quantity">{{ __('rooms.room_no')}}*</label>
                                    <input type="number" name="room_no" id="room_no" class="inputId">
                                </div>
                            </fieldset>
                            ...
                            <div class="part-block">
                                ...
                                <input type="number" name="guest_count" class="form-control inputId" id="guest_count">
                                <div>
                                    <label for="">{{ __('rooms.bathroom_count')}}*</label>
                                    <input type="number" name="bathroom_count" class="form-control inputId" id="bathroom_count">
                                </div>
                                <div>
                            ...
                            <div>
                                <fieldset>
                                    <div class="part-block position-relative">
                                        ...
                                        <input type="number" name="price" class="form-control inputId" id="price">
    ...
    <script>
        ...
        $(".inputId").on("keyup change", function(e) {
            ...
            if ($('form').find('#type').val() == '' || $('form').find('#name_pyc').val() == '' || $('form').find('#name').val() == ''
                ...
                ||  $('form').find("#fileUpload").val() == '' || $('form').find("#bathroom_count").val() == ''
                ||  $('form').find("#guest_count").val() == '' || $('form').find("#room_no").val() == ''
                ||  $('form').find("#price").val() == '' || $('form').find("#fileUpload").get(0).files[0] == undefined
                || $("#name-new-error").length != 0 || !$('form').find('#terms-conditions').is(':checked')
                ...
                if($('form').find('#type').hasClass('is-invalid') || $('form').find('#name_pyc').hasClass('is-invalid') || $('form').find('#name').hasClass('is-invalid')
                    ...
                    || $('form').find("#fileUpload").hasClass('is_invalid') || $('form').find('#bathroom_count').hasClass('is-invalid')
                    || $('form').find("#guest_count").hasClass('is_invalid') || $('form').find('#room_no').hasClass('is-invalid')
                    || $('form').find("#price").hasClass('is_invalid')
        ...
        //         $('input[name=map]').val(click_coord.toString())
        ...
        $(document).ready(() => {
            ...
            // $('#each-photo-block').on('click', ':radio', function() {
            //     console.log(this)

            //     $(".photoFigure").removeClass("active");
            //     $(this).parents(".photoFigure").toggleClass('active', this.checked);
            //     $('#fileInput').val($(this).parent().parent().parent().children().eq(1).attr('src'));
            // });
