...
@section('contents')
    ...
    <div id="hotel-page">
        <div class="container">
            ...
            <form action="{{ route('hotels.store', ['locale' => App::getLocale()])}}" class="hotel-form general-form" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="hidden" name="accommodation_type" value="hotel">
...
{{--                            <p>{{ __('hotel.sales_/desc_1')}}</p>--}}
                                ...
                                <section class="name-block info-block">
                                    <div>
                                        <div class="d-flex justify-content-between align-items-end label-part">
                                            <label for="" class="d-block">{{ __('hotel.hotel_name')}}*</label>
                        ...
                        <fieldset class="d-flex personal-info-form flex-column flex-md-row">
                            ...
                            <div class="part-block">
                                <div class="city">
                                    ...
                                    <input type="text" id="alt_phone" class="form-control inputId">
                ...
                <section class="booking-block info-block">
                    <div class="input-block">
                        ...
                        <div class="form-check form-switch d-flex">
                            ...
                            <input class="form-check-input" name="protection_booking" type="checkbox" id="clickOnOff" checked>
                ...
                <section>
                    {{--                <div class="bg-blue-block d-flex flex-column flex-md-row added-room-block justify-content-between">--}}
                    {{--                    <div class="added-room-text">--}}
                    {{--                        <p>Large double room with 1 bed</p>--}}
                    {{--                    </div>--}}
                    {{--                    <div class="quantity-box">--}}
                    {{--                        <span>Quantity:</span>--}}
                    {{--                        <span class="room-quantity">10</span>--}}
                    {{--                    </div>--}}
    ...
    <script>
        ...
        $(".inputId").on("keyup change", function(e) {
            ...
            if ($('form').find('#type').val() == '' || $('form').find('#name_pyc').val() == ''
                ...
                || $('form').find('#zip').val() == ''
                || $('form').find('#person').val() == ''
                || $('form').find('#phone').val() == ''
                || $('form').find('#in-from').val() == ''
                || $('form').find('#out-to').val() == ''
                || $('form').find('#description_pyc').val() == ''
                // || $('form').find("#stars").val() == ''
                ...
                if($('form').find('#type').hasClass('is-invalid') || $('form').find('#name_pyc').hasClass('is-invalid')
                    ||  $('form').find('#name').hasClass('is-invalid')
                    ...
                    is_valid = 0;
                    console.log('elseif', is_valid)
                } else {
                    is_valid = 1;
                    console.log('else', is_valid)
                }
            }
