...
@section('contents')
    ...
    <div id="hotel-page">
        <div class="container">
            ...
            <form action="{{ route('youth-hotels.update', ['locale' => App::getLocale(), 'youth_hotel' => $hotel])}}" class="hotel-form general-form" enctype="multipart/form-data" method="POST">
                @csrf
                @method('PUT')
                <input type="hidden" name="accommodation_type" value="{{$hotel->accommodation->type}}">
                <input type="hidden" name="youth_hotel_id" value="{{$id}}" >
                        ...
                        <div class="general-info-inner-block input-block">
                            <fieldset class="general-info-form">
                                ...
                                <div class="stars">
                                    ...
                                    <select name="stars_num" id="stars" style="font-size:120%; color:#FAAF40;" class="form-control inputId {{ $hotel->in_stock != '1' ? 'd-none' : ''}}">
                                    ...
                                    <select id="stocks_star"  name="stars_num" style="font-size:120%; color:#FAAF40;" class="form-control inputId {{ $hotel->in_stock == '1' ?'d-none': ''}}">
                                        <option value="0" style="font-size:120%; color:#000;" class="op0" >-</option>
                                ...
                                <div class="d-flex mb-3">
                                    <input type="checkbox" id="star_with_stock" name="in_stock" class="" {{ $hotel->in_stock == '1' ? 'checked' : ''}}>
                            ...
                            <fieldset class="check-in-out-form">
                                <div class="check-out-to">
                                    ...
                                    <select name="check_out_to" id="out-to" class="form-control inputId">
                                        <option value="0">{{ __('hotel.select')}}</option>
                                        <option value="00:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '00:00:00' ? 'selected': ''}}>00:00</option>
                                        <option value="01:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '01:00:00' ? 'selected': ''}}>01:00</option>
                                        <option value="02:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '02:00:00' ? 'selected': ''}}>02:00</option>
                                        <option value="03:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '03:00:00' ? 'selected': ''}}>03:00</option>
                                        <option value="04:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '04:00:00' ? 'selected': ''}}>04:00</option>
                                        <option value="05:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '05:00:00' ? 'selected': ''}}>05:00</option>
                                        <option value="06:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '06:00:00' ? 'selected': ''}}>06:00</option>
                                        <option value="07:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '07:00:00' ? 'selected': ''}}>07:00</option>
                                        <option value="08:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '08:00:00' ? 'selected': ''}}>08:00</option>
                                        <option value="09:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '09:00:00' ? 'selected': ''}}>09:00</option>
                                        <option value="10:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '10:00:00' ? 'selected': ''}}>10:00</option>
                                        <option value="11:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '11:00:00' ? 'selected': ''}}>11:00</option>
                                        <option value="12:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '12:00:00' ? 'selected': ''}}>12:00</option>
                                        <option value="13:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '13:00:00' ? 'selected': ''}}>13:00</option>
                                        <option value="14:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '14:00:00' ? 'selected': ''}}>14:00</option>
                                        <option value="15:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '15:00:00' ? 'selected': ''}}>15:00</option>
                                        <option value="16:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '16:00:00' ? 'selected': ''}}>16:00</option>
                                        <option value="17:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '17:00:00' ? 'selected': ''}}>17:00</option>
                                        <option value="18:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '18:00:00' ? 'selected': ''}}>18:00</option>
                                        <option value="19:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '19:00:00' ? 'selected': ''}}>19:00</option>
                                        <option value="20:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '20:00:00' ? 'selected': ''}}>20:00</option>
                                        <option value="21:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '21:00:00' ? 'selected': ''}}>21:00</option>
                                        <option value="22:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '22:00:00' ? 'selected': ''}}>22:00</option>
                                        <option value="23:00" {{ isset($hotel->accommodation->check_outs[0]) && $hotel->accommodation->check_outs[0]->to == '23:00:00' ? 'selected': ''}}>23:00</option>
                                    </select>
                                </div>
                            </fieldset>
                        </div>
                        ...
                        <div class="">
                            ...
                            <fieldset class="child-allow-part">
                                ...
                                <div class="lang-change-box">
                                    <textarea name="child_policy_pyc" id="child_policy_pyc" placeholder="Content" class="active">{{$hotel->accommodation->child_policy ?? ''}}</textarea>
                                    <textarea name="child_policy" id="child_policy" placeholder="Content">{{$hotel->accommodation->child_policy ?? ''}}</textarea>
                                </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="">
                            ...
                            <div>
                                ...
                                <div class="lang-change-box">
                                    ...
                                    <textarea name="description" id="description" placeholder="{{ __('hotel.content_placeholder')}}">{{ $hotel->accommodation->getTranslation('description','en') ?? ''}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @forelse ($hotel->rooms as $room)
                        <div class="bg-blue-block d-flex flex-column flex-md-row added-room-block justify-content-between" id="{{$room->id}}">
                            ...
                            <div class="d-flex flex-row flex-md-column added-room-btn-block">
                                ...
                                <button type="button" class="btn btn-grey deleteRoom" data-url="{{route('rooms.destroy', ['locale' => App::getLocale(), 'room' => $room])}}" id="btn-delete">delete</button>
                            </div>
                        </div>
                    @empty
