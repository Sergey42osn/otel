...
<div id="hotel-page">
    <div class="container">
        <div class="title-part">
            <h1>{{ __('hotel.villa_gen')}}</h1>
        </div>
        <form action="{{ route('villas.store', ['locale' => App::getLocale()])}}" class="hotel-form general-form" enctype="multipart/form-data" method="POST">
            @csrf
            <input type="hidden" name="accommodation_type" value="villa">
                ...
                <div class="d-flex justify-content-between flex-column flex-md-row">
                    <div class="general-info-inner-block input-block">
                        <fieldset class="general-info-form">
                            ...
                            <section class="name-block info-block mb-3">
                                <div>
                                    <div class="d-flex justify-content-between align-items-end label-part">
                                        <label for="" class="d-block">{{ __('hotel.villa_name')}}*</label>
                        ...
                        <fieldset class="d-flex flex-column">
                            ...
                            <div class="app-service-inner-block service-inner-block">
                                ...
                                <label for="price_{{$service->id}}" class="checkServiceInput checkBtn-label">
                                    <input type="number" placeholder="0" name="services[{{$service->id}}]" class="price" >{{ __('rooms.price')}}
                                </label>
                            </div>
                            @endforeach
                        </fieldset>
