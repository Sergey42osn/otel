...
<div id="hotel-page">
    <div class="container">
        ...
        <form action="{{ route('villas.update', ['locale' => App::getLocale(), 'villa' => $appartment])}}" class="hotel-form general-form" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')

            <input type="hidden" value="{{$id}}" name="obj_id"/>
                    ...
                    <div class="general-info-inner-block input-block">
                        <fieldset class="general-info-form">
                            ...
                            <div class="street">
                                ...
                                <input id="street" type="text" placeholder="Street and build number" name="street_house" class="form-control" value="{{$appartment->accommodation->address->street_house ?? ''}}">
                            </div>
                            <div class="zip">
                                <label for="zip">{{ __('hotel.zip_code')}}</label>
                                <input id="zip" type="text" placeholder="ZIP code" name="zip_code" class="form-control" value="{{$appartment->accommodation->address->zip_code ?? ''}}">
                            </div>
                        </fieldset>
                    </div>
                    <div class="map-block">
                    ...
                    <fieldset class="d-flex personal-info-form flex-column flex-md-row">
                        <div class="part-block">
                            <div class="person">
                                ...
                                <input id="person" type="text" placeholder="Name Surname" name="contact_person" class="inputId" value="{{$appartment->accommodation->contact_person ?? ''}}">
                            </div>
                            <div class="number">
                        ...
                        <fieldset class="d-flex flex-column">
                            ...
                            @foreach($appartment->accommodation->services as $service)
                                <div class="app-service-inner-block service-inner-block">
                                    <input type="checkbox" id="service_{{$service->id}}" onclick="openInput()" class="checkService checkBtn-label" {{ in_array($service->id, $selectedService) ? 'checked' : '' }}>
                    ...
                    <div class="">
                        ...
                        <div>
                            ...
                            <div class="lang-change-box">
                                ...
                                <textarea name="description" id="description" placeholder="Content" class="nputId">{{ $appartment->accommodation->getTranslation('description','en') ?? ''}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-block">
                    ...
                    <fieldset>
                        <div class="part-block">
                            ...
                            <input type="number" name="room_no" class="inputId" value="{{old('room_no',$appartment->room_no)}}">
                        </div>
                    </fieldset>
